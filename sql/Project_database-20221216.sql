...
INSERT INTO `兼修相關課程` VALUES ('AC073K','108-1',1,'財務金融學系'),('AC073K','108-1',1,'資訊工程學系'),('AC073K','108-1',2,'國際經營與貿易學系'),('AC073K','108-1',3,'科技管理跨領域學分學程'),('AC073K','109-1',1,'會計學系'),('AC073K','109-1',3,'化工系微型學程'),('AC073K','109-1',3,'會計學系'),('AC106A','108-1',2,'國際經營與貿易學系'),('AC106A','109-1',3,'系統晶片設計跨領域學分學程'),('AC237E','108-1',2,'國際經營與貿易學系'),('AC237E','108-1',2,'財務金融學系'),('AC237E','109-1',3,'系統晶片設計跨領域學分學程'),('AC435M','108-1',1,'資訊工程學系'),('AC435M','108-1',2,'國際經營與貿易學系'),('BA100A','108-1',2,'國際經營與貿易學系'),('BA100A','108-1',3,'科技管理跨領域學分學程'),('CS681R','108-1',3,'科技管理跨領域學分學程'),('CS681R','109-1',3,'化工系微型學程'),('CS681R','109-1',3,'系統晶片設計跨領域學分學程'),('ES791L','108-1',3,'科技管理跨領域學分學程'),('ES791L','109-1',1,'會計學系'),('ES791L','109-1',3,'人文素養跨領域學分學程'),('ES803L','108-1',3,'科技管理跨領域學分學程'),('GR507G','109-1',1,'會計學系'),('GR507G','109-1',3,'化工系微型學程'),('GR509A','109-1',3,'系統晶片設計跨領域學分學程');
...
INSERT INTO `學生資料` VALUES ('AAAA',9999,'維護者','9999','在學',NULL,111,NULL),('5400B',10742111,'黃一','5447','在學',NULL,111,'研究型'),('5400B',10742112,'黃二','5447','在學',NULL,111,'實用型'),('5400B',10742113,'黃三','5447','在學',NULL,111,'企業型'),('5400B',10742114,'黃四','5447','在學',NULL,111,'企業型'),('5400B',10742115,'黃五','5447','在學',NULL,111,'實用型'),('5400B',10742116,'黃六','5447','在學',NULL,111,'社會型'),('5400B',10842111,'張一','5447','在學',NULL,111,'研究型'),('5400B',10842112,'張二','5447','在學',NULL,111,'實用型'),('5400B',10842113,'張三','5447','在學',NULL,111,'企業型'),('5400B',10842114,'張四','5447','在學',NULL,111,'研究型'),('5300B',10843116,'孫六','4436','退學',NULL,10,'實用型'),('5300B',10843117,'孫七','4437','休學','0.5',110,'研究型'),('5300B',10843118,'孫八','4438','畢業',NULL,128,'企業型'),('5400B',10844111,'孫一','4441','畢業',NULL,134,'社會型'),('5400B',10844112,'孫二','4442','畢業',NULL,132,NULL),('5400B',10844113,'孫三','4443','畢業',NULL,128,NULL),('5400B',10844114,'孫四','4444','畢業',NULL,133,'研究型'),('5400B',10844115,'孫五','4445','在學','1.0',110,'研究型'),('5400B',10942115,'張五','5447','在學',NULL,111,'研究型'),('5300B',10943116,'王六','5436','在學',NULL,123,'實用型'),('5300B',10943117,'王七','5437','在學',NULL,111,'研究型'),('5400B',10943118,'王八','5438','在學',NULL,100,'企業型'),('5300B',10943119,'王九','5439','休學',NULL,73,NULL),('5400B',10944111,'王一','5441','在學',NULL,110,'研究型'),('5400B',10944112,'王二','5442','在學',NULL,92,'實用型'),('5400B',10944113,'王三','5443','在學',NULL,120,'社會型'),('5400B',10944114,'王四','5444','在學',NULL,120,'研究型'),('5400B',10944115,'王五','5445','休學',NULL,121,NULL),('5400B',10944116,'王六','5446','在學',NULL,123,NULL),('5400B',10944117,'王七','5447','在學',NULL,111,NULL);
...
INSERT INTO `學程申請` VALUES (10742111,'1232Z','107-1',NULL,'修習'),(10742112,'1232Z','108-1',NULL,'放棄'),(10742113,'1232Z','108-1',NULL,'通過'),(10742114,'1110Z','109-1','109-1','通過'),(10742115,'1232Z','109-1','109-1','通過'),(10742116,'1110Z','108-1',NULL,'通過'),(10843116,'1011Z','108-1',NULL,'修習'),(10843117,'1011Z','108-1',NULL,'通過'),(10843118,'1011Z','108-1',NULL,'修習'),(10843119,'1102Z','108-2',NULL,'取消'),(10844111,'1011Z','108-1',NULL,'修習'),(10844112,'1043Z','108-1','109-1','通過'),(10844114,'1011Z','108-1',NULL,'修習'),(10844115,'1011Z','108-1','','修習'),(10943117,'1110Z','109-1',NULL,'放棄'),(10943118,'1232Z','109-1',NULL,'修習'),(10944112,'1110Z','109-1',NULL,'取消');
...
-- Dump completed on 2022-12-16 12:04:12
